...
class LeasesControllerTest < ActionController::TestCase
  ...
  test "should create lease" do
    assert_difference('Lease.count') do
      post :create, lease: { endDate: @lease.endDate, rent: @lease.rent, securityDeposit: @lease.securityDeposit, startDate: @lease.startDate, unitNo: @lease.unitNo }
    end
  ...
  test "should update lease" do
    patch :update, id: @lease, lease: { endDate: @lease.endDate, rent: @lease.rent, securityDeposit: @lease.securityDeposit, startDate: @lease.startDate, unitNo: @lease.unitNo }
    assert_redirected_to lease_path(assigns(:lease))
  end
