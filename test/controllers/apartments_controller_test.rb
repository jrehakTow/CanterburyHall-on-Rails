...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { bathroom: @apartment.bathroom, bedroom: @apartment.bedroom, notes: @apartment.notes, sizeSQFT: @apartment.sizeSQFT, unitNumber: @apartment.unitNumber }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { bathroom: @apartment.bathroom, bedroom: @apartment.bedroom, notes: @apartment.notes, sizeSQFT: @apartment.sizeSQFT, unitNumber: @apartment.unitNumber }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
